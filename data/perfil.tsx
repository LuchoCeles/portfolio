...
export const perfilDatos = {
  ...
  enlaces: {
    ...
    whatsapp: "542235502054",
  },
};

// Props del ícono, compatibles con los íconos de lucide-react (size + className)
interface PropsIcono {
  size?: number;
  className?: string;
}

// Ícono de WhatsApp en SVG propio, ya que lucide-react descontinuó los íconos de marcas
function IconoWhatsapp({ size = 24, className }: PropsIcono) {
  return (
    <svg
...
// Enlaces de contacto / redes sociales con sus íconos
export const enlacesSociales = [
  {
    nombre: "GitHub",
  ...
  {
    nombre: "WhatsApp",
    href: `https://wa.me/${perfilDatos.enlaces.whatsapp}`,
    icono: IconoWhatsapp,
